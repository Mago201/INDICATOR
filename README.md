...
# GoldScalperPro — мульти-символьный скальпинг/интрадей (золото, FX, индексы, крипта) v1.20
...
**Новое в v1.20 (мульти-символьность):** профили инструмента с авто-детектом (золото/FX/JPY/индексы/крипта), **символо-независимые** фильтры волатильности (ATR-режим) и спреда (в долях ATR), авто-применение лучших часов.
