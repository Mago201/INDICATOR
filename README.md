...
# GoldScalperPro — скальпинг/интрадей для золота (XAUUSD) v1.10
...
**Новое в v1.10:** подтверждение со старшего ТФ (HTF), частичные цели **TP1/TP2** с переводом стопа в БУ, авто-анализ **лучших часов** по винрейту.
...
- Это подсказка: посмотрите лучшие часы → сузьте окно `InpSessStartHour/EndHour` под них.
