...
# GoldScalperPro — мульти-символьный скальпинг/интрадей (золото, FX, индексы, крипта) v1.30
...
**Новое в v1.30:** авто-разметка **Фибоначчи** от последнего свинга (ретрейсменты + расширения как кандидаты TP) и **астро-оверлей фаз Луны** (новолуние/полнолуние) — с прямой пометкой, что доказанного перевеса у фаз Луны нет, метки даны только для вашей визуальной проверки.
**v1.20 (мульти-символьность):** профили инструмента с авто-детектом, символо-независимые фильтры волатильности (ATR-режим) и спреда, авто-применение лучших часов.
**v1.10:** подтверждение со старшего ТФ (HTF), частичные цели TP1/TP2 с переводом в БУ, авто-анализ лучших часов.
